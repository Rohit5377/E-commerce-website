<%-- 
    Document   : register
    Created on : 6 Nov 2024, 10:24:27 pm
    Author     : Rohit Kumar1
--%>
            ...
            <div class="col-md-4 offset-md-4">
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input name="user_email" type="text" class="form-control" id="email" placeholder="Enter here" aria-describedby="emailHelp" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="container text-center">
                        ...
                        <button class="btn btn-outline-warning mt-2">Reset</button>
                    </div>
